...
Game.GMSS_03_G8level1.prototype =
{
    ...
    gameCreate: function (game) {
        ...
        _this.tdShapesArray = ['VpinkTriangle', 'HpinkTriangle', 'Hprism', 'Vprism', 'Vcone', 'Hcone', 'cube',
            'VblueTriangle', 'Vcylinder', 'Hcylinder', 'cuboid'];
        ...
        _this.backbtn.events.onInputDown.add(function () {
            _this.state.start('GMSS_03_G8Score');
        });
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/GMSS-03-G8/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    NextQuestion: function () {
        ...
        if (_this.numberOfQuestions < 3) {
            ...
            _this.timer1.stop();
            _this.timer1 = null;
            _this.time.events.add(1000, function () { _this.state.start('GMSS_03_G8Score') });
        }
    },
    ...
    InitialScreen: function () {
        ...
        _this.threeDShape = _this.add.image(_this.xPosArray[_this.tdChoiceArray[_this.count1]],
            _this.yPosArray[_this.tdChoiceArray[_this.count1]], _this.tdShapesArray[_this.tdChoiceArray[_this.count1]]);
        if (_this.tdShapesArray[_this.tdChoiceArray[_this.count1]] == 'VblueTriangle') _this.threeDShape.scale.setTo(0.6, 0.6);
        _this.addNumberPad();
        _this.clearArray.push(_this.threeDShape);

        console.log(_this.tdChoiceArray[_this.count1], "_this.tdChoiceArray[_this.count1]");
        console.log(_this.tdShapesArray[_this.tdChoiceArray[_this.count1]], "Shape");
    ...
    numClicked: function (target) {
        ...
        if (_this.vArray[_this.tdChoiceArray[_this.count1]] == 0 && _this.v_flag == 1) _this.vertices = true;
        ...
        if (_this.selectedAns2 === "")
            _this.enterTxt = _this.add.text(145, 20, "" + var_selectedAns1 + var_selectedAns2, { fontSize: '30px' });
        else
            _this.enterTxt = _this.add.text(140, 20, "" + var_selectedAns1 + var_selectedAns2, { fontSize: '30px' });
    ...
    wrongbtnClicked: function (target) {
        if (_this.vArray[_this.tdChoiceArray[_this.count1]] == 0 && _this.v_flag == 1) _this.vertices = false;
        _this.clickSound.play();
        _this.eraseScreen();
    },
    ...
    rightbtnClicked1: function (target) {
        ...
        if (_this.f_flag == 1) {
            if (Number('' + _this.selectedAns1 + _this.selectedAns2) == _this.fArray[_this.tdChoiceArray[_this.count1]]) {
                // _this.celebrationSound.play();
                console.log("Faces");
                _this.counterCelebrationSound.play();
                _this.fAnswer = _this.add.text(695, 120, _this.fArray[_this.tdChoiceArray[_this.count1]]);
            ...
            //console.log("Edges");
            if (Number('' + _this.selectedAns1 + _this.selectedAns2) == _this.eArray[_this.tdChoiceArray[_this.count1]]) {
                console.log("Edges");
                _this.counterCelebrationSound.play();
                if (_this.eArray[_this.tdChoiceArray[_this.count1]] > 9) {
                    _this.x = 690;
                } else { _this.x = 695 }
                _this.eAnswer = _this.add.text(_this.x, 220, _this.eArray[_this.tdChoiceArray[_this.count1]]);
                ...
                // _this.f_flag = 0;
                _this.e_flag = 0;
                if (_this.vArray[_this.tdChoiceArray[_this.count1]] == 0) _this.v_flag = 1;
            } else {
                // _this.Question_flag = 0;
                _this.wrongSound.play();
                _this.eraseScreen();
            ...
            if (_this.vArray[_this.tdChoiceArray[_this.count1]] == 0) {
                ...
                if (Number('' + _this.selectedAns1 + _this.selectedAns2) == _this.vArray[_this.tdChoiceArray[_this.count1]] && _this.vertices == true) {
            ...
            else if (Number('' + _this.selectedAns1 + _this.selectedAns2) == _this.vArray[_this.tdChoiceArray[_this.count1]]) {
    ...
    goSet1: function () {
        ...
        if (_this.dice[0] == 1) {
            ...
            if (_this.numbers[0] === 1) {
                ...
                _this.wrongChoiceArray = ['obj3', 'obj4', 'obj5', 'obj6', 'obj7',
                    'obj8', 'obj9', 'obj10', 'obj11', 'obj12', 'obj13', 'obj14', 'obj15', 'obj16', 'obj17'];
                _this.shuffleArray(_this.wrongChoiceArray);

                _this.theImage1 = _this.wrongChoiceArray[1];
                _this.getThePositionValues1();
                _this.right_shape1 = _this.add.image(_this.x1, _this.y1, _this.wrongChoiceArray[1]);
                if (_this.wrongChoiceArray[1] == 'obj8') _this.right_shape1.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[1] == 'obj7') _this.right_shape1.scale.setTo(0.85, 0.9);
                ...
                _this.wrong_shape2 = _this.add.image(_this.x3, _this.y3, _this.choiceArray[0]);
                if (_this.choiceArray[0] == 'obj8') _this.wrong_shape2.scale.setTo(0.9, 0.9);
                if (_this.choiceArray[0] == 'obj7') _this.wrong_shape2.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape2);

                _this.theImage4 = _this.wrongChoiceArray[2];
                _this.getThePositionValues4();
                _this.wrong_shape3 = _this.add.image(_this.x4, _this.y4, _this.wrongChoiceArray[2]);
                ...
                _this.theImage2 = _this.wrongChoiceArray[0];
                _this.getThePositionValues2();
                _this.right_shape2 = _this.add.image(_this.x2, _this.y2, _this.wrongChoiceArray[0]);
                if (_this.wrongChoiceArray[0] == 'obj8') _this.right_shape2.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[0] == 'obj7') _this.right_shape2.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.right_shape2);//_this.x2, _this.y2, _this.choiceArray[1]

                _this.theImage3 = _this.choiceArray[1];
                _this.getThePositionValues3();
                _this.wrong_shape1 = _this.add.image(_this.x3, _this.y3, _this.choiceArray[1]);
                if (_this.choiceArray[1] == 'obj8') _this.wrong_shape1.scale.setTo(0.9, 0.9);
                if (_this.choiceArray[1] == 'obj7') _this.wrong_shape1.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape1);//_this.x2, _this.y2

                _this.theImage4 = _this.wrongChoiceArray[1];
                _this.getThePositionValues4();
                _this.wrong_shape2 = _this.add.image(_this.x4, _this.y4, _this.wrongChoiceArray[1]);
            ...
            if (_this.numbers[0] === 1) {
                ...
                _this.theImage4 = _this.wrongChoiceArray[2];
                _this.getThePositionValues4();
                _this.right_shape1 = _this.add.image(_this.x4, _this.y4, _this.wrongChoiceArray[2]);//_this.x1, _this.y1, _this.choiceArray[0]
                if (_this.wrongChoiceArray[2] == 'obj8') _this.right_shape1.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[2] == 'obj7') _this.right_shape1.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.right_shape1);


                _this.theImage1 = _this.wrongChoiceArray[0];
                _this.getThePositionValues1();
                _this.wrong_shape1 = _this.add.image(_this.x1, _this.y1, _this.wrongChoiceArray[0]);
                if (_this.wrongChoiceArray[0] == 'obj8') _this.wrong_shape1.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[0] == 'obj7') _this.wrong_shape1.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape1);
                ...
                _this.getThePositionValues3();
                _this.wrong_shape2 = _this.add.image(_this.x3, _this.y3, _this.wrongChoiceArray[1]);
                if (_this.wrongChoiceArray[1] == 'obj8') _this.wrong_shape2.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[1] == 'obj7') _this.wrong_shape2.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape2);
                ...
                _this.getThePositionValues2();
                _this.wrong_shape3 = _this.add.image(_this.x2, _this.y2, _this.choiceArray[0]);//_this.x4, _this.y4, _this.wrongChoiceArray[2]
                if (_this.choiceArray[0] == 'obj8') _this.wrong_shape3.scale.setTo(0.9, 0.9);
                if (_this.choiceArray[0] == 'obj7') _this.wrong_shape3.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape3);
            } else {
                _this.choiceArray = ['obj1', 'obj2'];
                _this.shuffleArray(_this.choiceArray);
                ...
                _this.getThePositionValues4();
                _this.right_shape1 = _this.add.image(_this.x4, _this.y4, _this.choiceArray[1]);
                ...
                _this.getThePositionValues2();
                _this.right_shape2 = _this.add.image(_this.x2, _this.y2, _this.wrongChoiceArray[1]);
                if (_this.wrongChoiceArray[1] == 'obj8') _this.right_shape2.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[1] == 'obj7') _this.right_shape2.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.right_shape2);//_this.x2, _this.y2, _this.choiceArray[1]

                _this.theImage1 = _this.choiceArray[0];
                _this.getThePositionValue1();
                _this.wrong_shape1 = _this.add.image(_this.x1, _this.y1, _this.choiceArray[0]);
                if (_this.choiceArray[0] == 'obj8') _this.wrong_shape1.scale.setTo(0.9, 0.9);
                if (_this.choiceArray[0] == 'obj7') _this.wrong_shape1.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape1);

                _this.theImage3 = _this.wrongChoiceArray[0];
                _this.getThePositionValues3();
                _this.wrong_shape2 = _this.add.image(_this.x3, _this.y3, _this.wrongChoiceArray[0]);
                if (_this.wrongChoiceArray[0] == 'obj8') _this.wrong_shape2.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[0] == 'obj7') _this.wrong_shape2.scale.setTo(0.85, 0.9);
    ...
    goSet2: function () {
        ...
        if (_this.numbersTri[0] === 1) {
            ...
            _this.wrongChoiceArray = ['obj3', 'obj1', 'obj2', 'obj7', 'obj8', 'obj9', 'obj10',
                'obj11', 'obj12', 'obj13', 'obj14', 'obj15', 'obj16', 'obj17'];
            _this.shuffleArray(_this.wrongChoiceArray);

            _this.theImage4 = _this.choiceArray[0];
            _this.getThePositionValues4();
            _this.right_shape1 = _this.add.image(_this.x4, _this.y4, _this.choiceArray[0]);
            if (_this.choiceArray[0] == 'obj8') _this.right_shape1.scale.setTo(0.9, 0.9);
            if (_this.choiceArray[0] == 'obj7') _this.right_shape1.scale.setTo(0.85, 0.9);
            ...
            _this.getThePositionValues1();
            _this.wrong_shape3 = _this.add.image(_this.x1, _this.y1, _this.wrongChoiceArray[2]);
            if (_this.wrongChoiceArray[2] == 'obj8') _this.wrong_shape3.scale.setTo(0.9, 0.9);
            if (_this.wrongChoiceArray[2] == 'obj7') _this.wrong_shape3.scale.setTo(0.85, 0.9);
            _this.clearArray.push(_this.wrong_shape3);
            ...
            if (_this.choiceArray[1] == 'obj8') _this.right_shape3.scale.setTo(0.9, 0.9);
            if (_this.choiceArray[1] == 'obj7') _this.right_shape3.scale.setTo(0.85, 0.9);
    ...
    goSet3: function () {
        ...
        if (_this.numbersCylinder[0] === 1) {
            ...
            _this.choiceArray = ['obj7', 'obj12', 'obj8', 'obj11', 'obj15', 'obj16', 'obj17'];
            _this.shuffleArray(_this.choiceArray);
            _this.wrongChoiceArray = ['obj1', 'obj2', 'obj3', 'obj9',
                'obj10', 'obj13', 'obj14'];
            _this.shuffleArray(_this.wrongChoiceArray);
            ...
            _this.theImage2 = _this.choiceArray[0];
            _this.getThePositionValues2();
            _this.right_shape1 = _this.add.image(_this.x2, _this.y2, _this.choiceArray[0]);
            if (_this.choiceArray[0] == 'obj8') _this.right_shape1.scale.setTo(0.9, 0.9);
            if (_this.choiceArray[0] == 'obj7') _this.right_shape1.scale.setTo(0.85, 0.9);
            _this.clearArray.push(_this.right_shape1);
    ...
    goSet4: function () {
        ...
        if (_this.dice[0] == 1) {
            ...
            if (_this.numbersSet4[0] === 1) {
                ...
                _this.wrongChoiceArray = ['obj3', 'obj4', 'obj5', 'obj6', 'obj7',
                    'obj8', 'obj2', 'obj1', 'obj11', 'obj12', 'obj13', 'obj14', 'obj15', 'obj16', 'obj17'];
                _this.shuffleArray(_this.wrongChoiceArray);
            ...
            if (_this.numbersSet4[0] === 1) {
                ...
                _this.theImage4 = _this.wrongChoiceArray[2];
                _this.getThePositionValues4();
                _this.right_shape1 = _this.add.image(_this.x4, _this.y4, _this.wrongChoiceArray[2]);
                if (_this.wrongChoiceArray[2] == 'obj8') _this.right_shape1.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[2] == 'obj7') _this.right_shape1.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.right_shape1);//_this.x1, _this.y1, _this.choiceArray[0]
                ...
                _this.theImage3 = _this.choiceArray[0];
                _this.getThePositionValues3();
                _this.wrong_shape3 = _this.add.image(_this.x3, _this.y3, _this.choiceArray[0]);
                if (_this.choiceArray[0] == 'obj8') _this.wrong_shape3.scale.setTo(0.9, 0.9);
                if (_this.choiceArray[0] == 'obj7') _this.wrong_shape3.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape3);
            } else {
                ...
                _this.theImage3 = _this.wrongChoiceArray[0];
                _this.getThePositionValues3();
                _this.right_shape1 = _this.add.image(_this.x3, _this.y3, _this.wrongChoiceArray[0]);
                if (_this.wrongChoiceArray[0] == 'obj8') _this.right_shape1.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[0] == 'obj7') _this.right_shape1.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.right_shape1);//_this.x1, _this.y1, _this.choiceArray[0]

                _this.theImage1 = _this.wrongChoiceArray[1];
                _this.getThePositionValues1();
                _this.right_shape2 = _this.add.image(_this.x1, _this.y1, _this.wrongChoiceArray[1]);
                if (_this.wrongChoiceArray[1] == 'obj8') _this.right_shape2.scale.setTo(0.9, 0.9);
                if (_this.wrongChoiceArray[1] == 'obj7') _this.right_shape2.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.right_shape2);//_this.x2, _this.y2, _this.choiceArray[1]
                ...
                _this.theImage4 = _this.choiceArray[0];
                _this.getThePositionValues4();
                _this.wrong_shape1 = _this.add.image(_this.x4, _this.y4, _this.choiceArray[0]);
                if (_this.choiceArray[0] == 'obj8') _this.wrong_shape1.scale.setTo(0.9, 0.9);
                if (_this.choiceArray[0] == 'obj7') _this.wrong_shape1.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape1);
                ...
                _this.theImage2 = _this.choiceArray[1];
                _this.getThePositionValues2();
                _this.wrong_shape2 = _this.add.image(_this.x2, _this.y2, _this.choiceArray[1]);
                if (_this.choiceArray[1] == 'obj8') _this.wrong_shape2.scale.setTo(0.9, 0.9);
                if (_this.choiceArray[1] == 'obj7') _this.wrong_shape2.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape2);
            }
        }
    },
    ...
    goSet5: function () {
        ...
        if (_this.dice[0] == 1) {
            ...
            if (_this.numberSet5[0] === 1) {
                ...
                _this.wrongChoiceArray = ['obj3', 'obj4', 'obj5', 'obj6', 'obj7',
                    'obj8', 'obj2', 'obj1', 'obj11', 'obj12', 'obj10', 'obj9', 'obj15', 'obj16', 'obj17'];
                _this.shuffleArray(_this.wrongChoiceArray);
            ...
            if (_this.numberSet5[0] === 1) {
                ...
                _this.theImage2 = _this.choiceArray[0];
                _this.getThePositionValues2();
                _this.wrong_shape3 = _this.add.image(_this.x2, _this.y2, _this.choiceArray[0]);
                if (_this.choiceArray[0] == 'obj8') _this.wrong_shape3.scale.setTo(0.9, 0.9);
                if (_this.choiceArray[0] == 'obj7') _this.wrong_shape3.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape3);
            } else {
                ...
                _this.theImage4 = _this.choiceArray[1];
                _this.getThePositionValues4();
                _this.wrong_shape2 = _this.add.image(_this.x4, _this.y4, _this.choiceArray[1]);
                if (_this.choiceArray[1] == 'obj8') _this.wrong_shape2.scale.setTo(0.9, 0.9);
                if (_this.choiceArray[1] == 'obj7') _this.wrong_shape2.scale.setTo(0.85, 0.9);
                _this.clearArray.push(_this.wrong_shape2);
            }
    ...
    goSet6: function () {
        ...
        _this.wrongChoiceArray = ['obj4', 'obj5', 'obj6', 'obj7', 'obj13', 'obj14',
            'obj8', 'obj2', 'obj1', 'obj11', 'obj12', 'obj10', 'obj9', 'obj15', 'obj16', 'obj17'];
        _this.shuffleArray(_this.wrongChoiceArray);
        ...
        if (_this.goSet_flag1) {
            if (_this.dice[0] == 1) {
                ...
                if (_this.numbers[0] == 2) {
                    console.log("2 >>");
                    if (_this.selectedBox1 == true && _this.selectedBox3 == true && _this.selectedBox4 === false && _this.selectedBox2 == false) {
                        _this.celebrationSound.play();
                        //  _this.tick.inputEnabled = true;
                        _this.disableBoxes();
                        _this.starActions();
                ...
                if (_this.numbers[0] == 2) {
                    console.log("2 >>");
                    if (_this.selectedBox1 == true && _this.selectedBox4 == true && _this.selectedBox3 === false && _this.selectedBox2 == false) {
                        _this.celebrationSound.play();
                        //  _this.tick.inputEnabled = true;
                        _this.disableBoxes();
                        _this.starActions();
                    ...
                    console.log("1 >>");
                    if (_this.selectedBox2 == true && _this.selectedBox3 == false && _this.selectedBox1 == false && _this.selectedBox4 === false) {
                        _this.celebrationSound.play();
                        //_this.tick.inputEnabled = true;
                        _this.disableBoxes();
                        _this.starActions();
            ...
            if (_this.numbersTri[0] == 3) {
                ...
                console.log("2 >>");
                if (_this.selectedBox4 == true && _this.selectedBox3 == true && _this.selectedBox2 === false && _this.selectedBox1 == false) {
                    _this.celebrationSound.play();
                    //_this.tick.inputEnabled = true;
                    _this.disableBoxes();
                    _this.starActions();
                ...
                console.log("1 >>");
                if (_this.selectedBox4 == true && _this.selectedBox2 == false && _this.selectedBox1 == false && _this.selectedBox3 === false) {
                    _this.celebrationSound.play();
                    //_this.tick.inputEnabled = true;
                    _this.disableBoxes();
                    _this.starActions();
                ...
                } else if (_this.selectedBox3 == true || _this.selectedBox2 == true || _this.selectedBox1 == true) {
                    if (_this.selectedBox3 == true) {
                        _this.handleSelectedBox(_this.Box2_3, _this.selectedBox3, _this.wrongSound);
                        _this.selectedBox3 = false;
                    }
            ...
            if (_this.numbersCylinder[0] == 3) {
                console.log("3 >>");
                if (_this.selectedBox4 == true && _this.selectedBox3 == true && _this.selectedBox2 == true && _this.selectedBox1 === false) {
                    _this.celebrationSound.play();
                ...
                console.log("2 >>");
                if (_this.selectedBox3 == true && _this.selectedBox2 == true && _this.selectedBox1 === false && _this.selectedBox4 == false) {
                    _this.celebrationSound.play();
                    // _this.tick.inputEnabled = true;
                    _this.disableBoxes();
                    _this.starActions();
                ...
                console.log("1 >>");
                if (_this.selectedBox2 == true && _this.selectedBox1 == false && _this.selectedBox4 == false && _this.selectedBox3 === false) {
                    _this.celebrationSound.play();
                    // _this.tick.inputEnabled = true;
                    _this.disableBoxes();
                    _this.starActions();
                ...
                } else if (_this.selectedBox3 == true || _this.selectedBox1 == true || _this.selectedBox4 == true) {
                    if (_this.selectedBox3 == true) {
                        _this.handleSelectedBox(_this.Box2_3, _this.selectedBox3, _this.wrongSound);
                        _this.selectedBox3 = false;
                    }
            ...
            if (_this.dice[0] == 1) {
                if (_this.numbersSet4[0] == 2) {
                    console.log("2 >>");
                    if (_this.selectedBox3 == true && _this.selectedBox2 == true && _this.selectedBox4 === false && _this.selectedBox1 == false) {
                        _this.celebrationSound.play();
                        //_this.tick.inputEnabled = true;
                        _this.disableBoxes();
                        _this.starActions();
                    ...
                    console.log("1 >>");
                    if (_this.selectedBox1 == true && _this.selectedBox3 == false && _this.selectedBox4 == false && _this.selectedBox2 === false) {
                        _this.celebrationSound.play();
                        //_this.tick.inputEnabled = true;
                        _this.disableBoxes();
                        _this.starActions();
                    ...
                    } else if (_this.selectedBox3 == true || _this.selectedBox2 == true || _this.selectedBox4 == true) {
                        if (_this.selectedBox3 == true) {
                            _this.handleSelectedBox(_this.Box2_3, _this.selectedBox3, _this.wrongSound);
                            _this.selectedBox3 = false;
                        }
                ...
                if (_this.numbersSet4[0] == 2) {
                    console.log("2 >>");
                    if (_this.selectedBox2 == true && _this.selectedBox4 == true && _this.selectedBox1 === false && _this.selectedBox3 == false) {
                        _this.celebrationSound.play();
                        //_this.tick.inputEnabled = true;
                        _this.disableBoxes();
                        _this.starActions();
                    ...
                    console.log("1 >>");
                    if (_this.selectedBox3 == true && _this.selectedBox4 == false && _this.selectedBox1 == false && _this.selectedBox2 === false) {
                        _this.celebrationSound.play();
                        // _this.tick.inputEnabled = true;
                        _this.disableBoxes();
                        _this.starActions();
            ...
            if (_this.dice[0] == 1) {
                if (_this.numberSet5[0] == 2) {
                    ...
                    console.log("1 >>");
                    if (_this.selectedBox4 == true && _this.selectedBox3 == false && _this.selectedBox2 == false && _this.selectedBox1 === false) {
                        _this.celebrationSound.play();
                        _this.disableBoxes();
                        _this.starActions();
                        _this.time.events.add(3000, () => {
                ...
                if (_this.numberSet5[0] == 2) {
                    console.log("2 >>");
                    if (_this.selectedBox1 == true && _this.selectedBox4 == true
                        && _this.selectedBox3 === false && _this.selectedBox2 == false) {
                        _this.celebrationSound.play();
                        _this.disableBoxes();
                        _this.starActions();
                        _this.time.events.add(3000, () => {
                    ...
                    console.log("1 >>");
                    if (_this.selectedBox2 == true && _this.selectedBox3 == false && _this.selectedBox4 == false
                        && _this.selectedBox1 === false) {
                        _this.celebrationSound.play();
                        _this.disableBoxes();
                        _this.starActions();
                    ...
                    } else if (_this.selectedBox3 == true || _this.selectedBox4 == true || _this.selectedBox1 == true) {
            ...
            if (_this.numbersRect[0] == 1) {
                ...
                if (_this.selectedBox2 == true && _this.selectedBox3 == false && _this.selectedBox4 == false && _this.selectedBox1 === false) {
                    _this.celebrationSound.play();
                    _this.disableBoxes();
                    _this.starActions();
                    _this.time.events.add(3000, () => {
                ...
                if (_this.selectedBox4 == true && _this.selectedBox3 == false && _this.selectedBox1 == false && _this.selectedBox2 === false) {
                    _this.celebrationSound.play();
                    _this.disableBoxes();
                    _this.starActions();
                    _this.time.events.add(3000, () => {
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/INT-DL3-G7/" + _this.languageSelected + "/V1.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        _this.demoAudio2 = document.createElement('audio');
        _this.demoAudio2src = document.createElement('source');
        _this.demoAudio2src.setAttribute("src", "questionSounds/INT-DL3-G7/" + _this.languageSelected + "/V2.mp3");
        _this.demoAudio2.appendChild(_this.demoAudio2src);

        // QUESTION AUDIOS
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/INT-DL3-G7/" +
